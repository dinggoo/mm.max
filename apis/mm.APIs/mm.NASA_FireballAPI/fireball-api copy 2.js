...
function outputFireballs(data) {
  ...
  // Clear and prepare dictionary
  Max.outlet('dictionary', 'fireballDict', 'clear');
  Max.outlet('dictionary', 'fireballDict', 'replace', 'count', data.count);
  ...
  data.data.forEach((record, index) => {
    ...
    if (dateIdx >= 0 && record[dateIdx]) {
      ...
      Max.outlet('dictionary', 'fireballDict', 'replace', `${fireballKey}::date`, record[dateIdx]);
    }
    ...
    if (latIdx >= 0 && record[latIdx] !== null) {
      ...
      // Add to dictionary
      Max.outlet('dictionary', 'fireballDict', 'replace', `${fireballKey}::latitude`, latSigned);
      Max.outlet('dictionary', 'fireballDict', 'replace', `${fireballKey}::longitude`, lonSigned);
    }
    ...
    if (altIdx >= 0 && record[altIdx] !== null) {
      ...
      Max.outlet('dictionary', 'fireballDict', 'replace', `${fireballKey}::altitude`, altitude);
    }
    ...
    if (energyIdx >= 0 && record[energyIdx]) {
      ...
      // Add to dictionary
      Max.outlet('dictionary', 'fireballDict', 'replace', `${fireballKey}::energy`, energy);
      Max.outlet('dictionary', 'fireballDict', 'replace', `${fireballKey}::energy_joules`, energy * 1e10);
    }
    ...
    if (impactIdx >= 0 && record[impactIdx]) {
      ...
      Max.outlet('dictionary', 'fireballDict', 'replace', `${fireballKey}::impact_energy`, impactEnergy);
    }
    ...
    if (vxIdx >= 0 && record[vxIdx] !== null) {
      ...
      // Add to dictionary
      Max.outlet('dictionary', 'fireballDict', 'replace', `${fireballKey}::velocity_x`, vx);
      Max.outlet('dictionary', 'fireballDict', 'replace', `${fireballKey}::velocity_y`, vy);
      Max.outlet('dictionary', 'fireballDict', 'replace', `${fireballKey}::velocity_z`, vz);
      Max.outlet('dictionary', 'fireballDict', 'replace', `${fireballKey}::velocity_total`, velocity);
    }
